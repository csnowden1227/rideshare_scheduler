  ...
  try {
    ...
    return res.json({
      ...
      fleet: sanitizedFleet.map((vehicle) => ({
        ...
        use_make_model_label: !!vehicle.use_make_model_label,
...
function buildCrmBookingPayload({
  ...
  return {
    ...
    booking: {
      ...
      pickup_datetime: booking.start_time || null,
      pickup_datetime_display: booking.start_time ? formatDisplayDateTime(booking.start_time) : null,
      end_time: booking.end_time || null,
      end_time_display: booking.end_time ? formatDisplayDateTime(booking.end_time) : null,
      end_datetime: booking.end_time || null,
      end_datetime_display: booking.end_time ? formatDisplayDateTime(booking.end_time) : null,
...
res.json({
  ...
  fleet: sanitizedFleet.map(v => ({
    ...
    use_make_model_label: !!v.use_make_model_label,
