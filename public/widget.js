  ...
  function renderVehiclePicker(fleet = []) {
    ...
    const cards = orderedFleet.map((vehicle, index) => {
      ...
      return `
        ...
        >
          <span style="font-size:11px;font-weight:700;color:#111827;line-height:1.05;padding:4px 4px 0;margin:0;white-space:normal;overflow:hidden;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;">${escapeHtml(label)}</span>
